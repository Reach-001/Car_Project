 ...
 * 按键消抖驱动 —— 硬件抽象层头文件
 *
 * 硬件：PA11=KEY1, PA12=KEY2, PA15=KEY3（外部上拉，按下=低电平）
 *       PC13=User_Key（按下=高电平）
 *
...
typedef enum
{
    BSP_KEY_1 = 0,          /* PA11  — 外部上拉，按下=低 */
    BSP_KEY_2,              /* PA12  — 外部上拉，按下=低 */
    BSP_KEY_3,              /* PA15  — 外部上拉，按下=低 */
    BSP_KEY_4,              /* PC13  — User_Key，按下=高 */
    BSP_KEY_COUNT           /* 按键总数 */
} BspKeyId;
